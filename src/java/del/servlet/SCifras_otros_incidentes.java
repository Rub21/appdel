 ...
 * @author ruben
 */
public class SCifras_otros_incidentes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            bCifras = managerCifras.listarcifras_otros_incidentes();

            System.out.println("---------" + bCifras.toString());
            String json = new Gson().toJson(bCifras);
            response.setContentType("application/json");
            response.setCharacterEncoding("UTF-8");
            response.getWriter().write("var cifras_otros_incidentes =" +json);
