 ...
 * @author ruben
 */
public class SCifras_total_crimen extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            bCifras_totales = managerCifras.listarcifras_totales_crimen();

            System.out.println("---------" + bCifras_totales.toString());
            String json = new Gson().toJson(bCifras_totales);
            response.setContentType("application/json");
            response.setCharacterEncoding("UTF-8");
            response.getWriter().write("var cif_crimen =" + json);
