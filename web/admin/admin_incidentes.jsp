...
<html>
    <head>
        ...
        <title>Administrar Incidentes</title>
        ...
        <link rel="stylesheet" href="css/styles_amin_incidente.css" />
            ...
            <div id="modal">
                <div id="popover" class="modal container hide fade" tabindex="-1">
                    ...
                    <div class="modal-footer">
                        <form name="form" id="form"  action="<%=request.getContextPath()%>/SActualizar_incidente">             
                        <input name="id_incidente" id="id_incidente" style="display: none"/>
                        <button type="button"  id="button_submit" class="btn btn-success">Aprobar su publicación</button>  
